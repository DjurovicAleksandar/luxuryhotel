...
function Island({ onIsActive }) {
  ...
  const videoScale = useTransform(scrollYProgress, [0.5, 0.6], [1, 2]);
  const textY = useTransform(scrollYProgress, [0.4, 0.6], [0, 200]);

  const opacityY = useTransform(scrollYProgress, [0.3, 0.5], [1, 0]);
    ...
    return (
      ...
      >
        ...
        <div className="-translate-y-10 lg:-translate-y-14">
          <h2 className="text-[2.8em] leading-10 prism  lg:text-[4.625em]">
            Living on Bali
          </h2>
        </div>
